...
function makeCall (config, iconfig, pem, rejectUnauthorized) {
    ...
    if (pem != null) {
        let rej = (rejectUnauthorized === null) ? true : rejectUnauthorized ;
        let agent = new Https.Agent({ca: pem, rejectUnauthorized: rej});
        config.httpsAgent = agent;
    } else if (rejectUnauthorized != null) {
        let agent = new Https.Agent({rejectUnauthorized: rejectUnauthorized});
        config.httpsAgent = agent;
    }
