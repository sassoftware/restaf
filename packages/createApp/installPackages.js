...
module.exports = function installPackages (appDirectory, installList, useDefault){
	return new Promise((resolve) => {
		...
		let list = (useDefault === true) ? `rimraf @sassoftware/restaf-server @sassoftware/restaf @sassoftware/restaflib react-router-dom cross-env shelljs cross-spawn http-proxy-middleware` : ' ';
		if (installList !== null) {
