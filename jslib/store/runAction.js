...
function runAction(_x, _x2, _x3, _x4) {
...
function _runAction() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(store, session, payload, casProxy) {
    var rel, actionResult;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            rel = casProxy === true ? 'casproxy' : 'execute';
            /* for debugging casproxy issue  */
